 ...
 * @endcode
 */
$settings['hash_salt'] = 'j7WIKexUVky0bvw1cC4ArOBPN-BaZxsuhGVQ-B6bijYqBqniwUtcwBdozHDHsGom-fFPfn8HBg';
...
$settings['trusted_host_patterns'] = [
  '^localhost$',
  '^hedrich-alsfeld\.localhost$',
  '^www\.hedrich-alsfeld\.com$',
  '^hedrich-alsfeld\.com$',
];
 ...
 */
#
if (!empty($_SERVER['APP_ENV']) && $_SERVER['APP_ENV'] == 'local' && file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
...
$settings['config_sync_directory'] = 'sites/default/files/config_GO8e_q-tFAHNe5NSuIV8hd1pDeQTUd1Kv6IvfkCcnOC8wHkKlMY_jh-BeOpi1tpQaRz2_boctA/sync';
